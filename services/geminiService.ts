...
export const geminiService = {
  getJarvisResponse: async (
    ...
    const systemInstruction = `
      ...
      3.  عند البحث عن معلومات (باستخدام الأداة المتوفرة)، أعطِ الأولوية القصوى للمصادر الأكاديمية والعلمية المتوفرة في الجزائر (مثل المجلات الجامعية الجزائرية، بوابات البحث الجزائرية، رسائل الدكتوراه والماجستير الجزائرية)، ثم المصادر العالمية الموثوقة.
